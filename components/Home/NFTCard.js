...
const style = {
  wrapper: `relative flex h-[450px] w-[340px] cursor-pointer flex-col rounded-lg bf-white shadow-lg transition-all duration-300 hover:shadow-2xl dark:bg-[#333333] `,
...
const NFTCard = ({listing}) => {
  ...
  <div className={style.nftInfoContainer}>
    ...
    <div className = {style.priceContainer}>
      <div className = {style.priceTitle}> Mua: </div>
  ...
  <div className={style.likesContainer}>
    ...
    <div className={style.likeCounter}>
      {listing.asset?.starts?.favorites ?? 0}
    </div>
  </div>
</div> 
    </div>
